...
You have two ways to convert your models - automatic and manual mode. If you select automatic mode (a), the program will read all the paths you need from the "paths.txt " file that you must create in directory with program, after that converting will begin. 
