...
Generates a .vmdl file that will tell Source 2 to import its accompanying .mdl file (Linux support is included). You **must** leave the .mdl with the .vmdl file, or else it won't compile!
...
![screenshot_automode_example](https://i.imgur.com/uDRQRX4.png)
...
![screenshot_manualmode_example](https://i.imgur.com/HUkbmFr.png)
